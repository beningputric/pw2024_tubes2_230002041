...
function buat_link_halaman($id){
    ...
    // http://localhost/pw2024_tubes_230002041/halaman.php/8/judul
...
function pakaianadat_foto($id){
    global $koneksi;
    $sql1   = "select * from pakaianadat where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $foto   = $r1['foto'];
...
function buat_link_pakaianadat($id){
    global $koneksi;
    $sql1    = "select * from pakaianadat where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    ...
    // http://localhost/pw2024_tubes_230002041/halaman.php/8/judul
    return url_dasar()."/pakaianadat.php/$id/$nama";
}
...
function buat_link_partners($id){
    ...
    $r1     = mysqli_fetch_array($q1);
    $nama  = bersihkan_judul($r1['nama']);
    // http://localhost/pw2024_tubes_230002041.php/8/judul
