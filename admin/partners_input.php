...
if (isset($_POST['simpan'])) {
    ...
    //Array ( [foto] => Array ( [name] => Lampung.jpg [type] => image/jpeg [tmp_name] => C:\xampp2\tmp\php4FDD.tmp [error] => 0 [size] => 2375701 ) )
    // print_r($_FILES);
    if($_FILES['foto']['name']){
        ...
        // Array ( [dirname] => . [basename] => Dayak.jpg [extension] => jpg [filename] => Dayak )
